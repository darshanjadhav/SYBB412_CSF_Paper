...
# Initialize paths
data_path <- "/home/mxg979/Project/SYBB412/seurat_object_06/bulk_expression"
output_parent_dir <- "/home/mxg979/Project/SYBB412/results/"
...
#------------------------------------------------------------------------------
# Define functions (Fig 2A-B, SuppFig2)
...
execute_on_celltype <- function(data, clonal, Diagnosis, sex, cell_type, output_parent_dir) {
  ...
  load(paste0("/home/mxg979/Project/SYBB412/seurat_object_06/", cell_type_label, "_over10_genes"))
  genes <- over10_genes
