...
qc_plot_dir <- "/home/mxg979/Project/SYBB412/qc_plots"
seurat_obj_dir <- "/home/mxg979/Project/SYBB412/seurat_object"
...
run_doubletfinder <- function(s) {
  ...
  # Run DoubletFinder
  s <- doubletFinder(s, PCs = 1:12, pN = 0.25, pK = optimal_pK, nExp = nExp_poi, reuse.pANN = NULL, sct = FALSE)
...
s@meta.data$age <- factor(s@meta.data$age, levels = c(48, 54, 55, 56,
