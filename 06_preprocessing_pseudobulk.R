...
output_dir <- "/home/mxg979/Project/SYBB412/seurat_object_06/"
...
bulk_by_id <- function(s, clonal = FALSE) {
  ...
  print("PPPPPPPPPPPP")
  counts <- GetAssayData(object = seurat5_, assay = "RNA", layer = "counts")
...
#data <- GetAssayData(object = s, assay = "RNA", slot = "counts") %>% as.matrix()
  ...
  #obj_new = JoinLayers(s)
  print("PPPPPPPPPPPP")
  data <- GetAssayData(object = seurat5_, assay = "RNA", layer = "counts")%>% as.matrix()
